...
public class ReviewController {
	...
	@PutMapping("/{rid}/hotel/{hid}")
	public ResponseEntity<ReviewResponseDTO> updateHotelByReviewId(@PathVariable int rid,@PathVariable int hid)throws InvalidInputDataException
	{
		
		// call service layer & update student with course
		
		Review updatedReview = reviewService.updateHotelbyReviewId(rid, hid);
		if(updatedReview != null)
		{
			ReviewResponseDTO dto = reviewDTOConvertor.getReviewResponseDTO(updatedReview);
	...
	@GetMapping("/{rid}")
	public ResponseEntity<ReviewResponseDTO> getReviewById(@PathVariable int rid)throws InvalidInputDataException
	{
		
			Review savedReview = reviewService.getReviewById(rid);
			ReviewResponseDTO dto = reviewDTOConvertor.getReviewResponseDTO(savedReview);
			return new ResponseEntity<ReviewResponseDTO>(dto,HttpStatus.OK);
